 ...
 */
typedef uint32_t rados_enumerate_cursor;
...
CEPH_RADOS_API rados_enumerate_cursor rados_enumerate_objects_begin(
    rados_ioctx_t io);

CEPH_RADOS_API rados_enumerate_cursor rados_enumerate_objects_end(
    rados_ioctx_t io);
